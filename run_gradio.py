...
from create_db import create_db_info
...
LLM_MODEL_DICT = {
    ...
    "zhipuai": ["glm-4", "chatglm_std", "chatglm_lite"]
}
...
AIGC_AVATAR_PATH = "serve/flower.png"
DATAWHALE_AVATAR_PATH = "serve/rainbow.png"
AIGC_LOGO_PATH = "serve/flower.png"
DATAWHALE_LOGO_PATH = "serve/rainbow.png"
...
with block as demo:
    with gr.Row(equal_height=True):           
        ...
        with gr.Column(scale=2):
            gr.Markdown("""<h1><center>B站视频字幕个人知识库助手</center></h1>
                <center>WYT-assistant</center>
                """)
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            file_upload = gr.Files(label='请选择知识库文件', file_types=['.txt', '.md', '.docx', '.pdf'])
        ...
        init_db.click(create_db_info,
                      inputs=[file_upload, embeddings], outputs=[msg])
